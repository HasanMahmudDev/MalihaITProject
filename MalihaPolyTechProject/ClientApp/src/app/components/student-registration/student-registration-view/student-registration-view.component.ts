...
@Component({
  selector: 'app-student-registration-view',
  templateUrl: './student-registration-view.component.html',
  styleUrls: ['./student-registration-view.component.css']
})
export class StudentRegistrationViewComponent implements OnInit {
  ...
  columnList = ["studentId", "courseId", "enrollDate","isPaymentComplete", "actions"];
